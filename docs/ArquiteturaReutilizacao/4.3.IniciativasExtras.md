...
| 0.3    | Registrando retrospectiva           | Luiz Henrique                   | 09/09/2022 |
| 0.4    | Documentando a Issue Battle         | Victor Buendia                  | 09/09/2022 |
...
Em uma tentativa de promover a interação e partilha de conhecimento entre os membros da equipe durante o desenvolvimento de código e modelagem do Módulo 4, fizemos uma issue battle na casa de um dos nossos membros. Nela, colocamos em prática o pair programming do XP, que é uma das metodologias de desenvolvimento que escolhemos seguir no início do projeto.

![Issue Battle](../imgs/issuebattle.jpg)
