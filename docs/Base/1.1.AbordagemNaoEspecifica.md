...
| 1.0  | Adicionando o topico de Instropecção | Luiz Henrique, Victor Eduardo, Sávio Cunha |
...
Nessa fase támbem foi realizado a Elicitação dos Requisitos para construir o Backlog do Produto. A estratégia para isso foi utilizar duas principais tecnicas o Brainstorm e Introspecção, tendo em vista que o grupo já possuía artefatos que delimitavam bem o escopo e visão do produto (5H2W, Ishikawa, Rich Picture e Storyboard). Assim, com apoio do que já havia sido construído, os requisitos funcionais e não funcionais foram levantados nessa fase.
