...
| 0.7    | Refinando os tópicos 1.1.3.3, 1.1.3.4, 1.1.3.5                                                       | Victor Buendia                                                                                                          |
...
A última fase é a validação. Nela, faremos a verificação ou a validação do Protótipo de Alta Fidelidade construído. Aqui a ideia é garantir que o nosso produto está atendendo expectativas dos usuários e que está sendo construído de acordo com o que foi modelado nos artefatos construídos ao longo de toda a Design Sprint.
