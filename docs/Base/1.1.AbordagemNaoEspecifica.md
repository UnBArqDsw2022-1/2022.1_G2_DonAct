...
| 0.5    | Documentação Rich picture nos tópicos 1.1.3.2 e 1.1.3.3 e adicionado apêndice | Luiz Henrique, Cibele Goudinho |
...
| 0.8    | Documentação Brainstorming, Backlog e priozição | Luiz Henrique, Carlos Rafael |                                  |
| 0.9   | Adicionando o tópico 1.1.3.4.1.1 Processo de Gerenciamento dos Riscos                                | Victor Buendia  |
...
Após o processo de Elicitação de Requisitos as 26 Histórias de usuário geradas foram consolidadas no Backlog do produto que visa reunir, organizar e gerenciar os requisitos do sistema. 
...
| US25 | FE11 - Home externa | Eu como usuário desejo receber acessar o site e ver informações gerais do sistema sem precisar fazer cadastro ou login | RF | Shoud |
