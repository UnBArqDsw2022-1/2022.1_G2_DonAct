...
O diagrama de Ishikawa (Diagrama de Causa e Efeito), visa encontrar potenciais causas de uma evento específico sobre diferentes perspectivas, ou seja, descobrir e documentar os fatores que resultam em situações indesejadas. 

No projeto utilizamos o Ishikawa em junção com a técnica de brainstorming, o que nos ajudou a identificar parte das causas e trouxe melhor visibilidade dos problemas; permitindo que o artefato seja bem útil em futuras análises.
...
- O que é Diagrama de Ishikawa?  Disponível em: https://www.siteware.com.br/metodologias/diagrama-de-ishikawa/
