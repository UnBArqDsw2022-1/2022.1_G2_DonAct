...
| ----| ------ |-------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ | ----------- | --------------------------------------------- |
| US01 | E01-Cadastro | FE01 - Cadastro de doador           | Eu como usuário doador desejo me cadastrar no site                                                                                                 | RF                       | Must        | <a href="#Brainstorming" > Brainstorming </a>  |
| US02 | E01-Cadastro |FE01 - Cadastro de doador           | Eu como usuário doador não desejo que sejam cadastrados usuários doadores com o mesmo CPF que o meu                                                | RNF                      | Should      | <a href="#Brainstorming" > Brainstorming </a> |
| US03 | E01-Cadastro | FE02 - Cadastro de ONG              | Eu como usuário membro de uma ONG desejo me cadastrar no site                                                                                      | RF                       | Should      | <a href="#Brainstorming" > Brainstorming </a> |
| US04 | E01-Cadastro | FE02 - Cadastro de ONG              | Eu como usuário não desejo que sejam cadastrados outros usuários utilizando o mesmo CNPJ que o meu                                                 | RNF                      | Should      | <a href="#Brainstorming" > Brainstorming </a> |
| US05 | E01-Cadastro | FE02 - Cadastro de ONG              | Eu como usuário doador desejo que as empresas que receberão minhas doações sejam cadastrados Empresas sem fins lucrativos                          | RNF                      | Must        | <a href="#Brainstorming" > Brainstorming </a> |
| US06 | E02 - Itens | FE03 - Adicionar item               | Eu como usuário doador desejo oferecer um item para doação                                                                                         | RF                       | Must        | <a href="#Brainstorming" > Brainstorming </a> ,  <a href="#mapa-mental" > Mapa Mental </a> |
| US07 | E02 - Itens | FE03 - Adicionar item               | Eu como usuário doador desejo remover um item para doação                                                                                          | RF                       | Must        | <a href="#Brainstorming" > Brainstorming </a> |
| US08 | E02 - Itens | FE03 - Adicionar item               | Eu como usuário doador desejo editar um item para doação                                                                                           | RF                       | Shold       | <a href="#Brainstorming" > Brainstorming </a> |
| US09 | E02 - Itens | FE03 - Adicionar item               | Eu como usuário doador desejo selecionar para qual ONG vou doar meus itens                                                                         | RF                       | Must        | <a href="#Brainstorming" > Brainstorming </a> |
| US10 | E02 - Itens | FE04 - Solicitar item               | Eu como usuário membro de uma ONG desejo solicitar ou remover um item da lista de itens que preciso                                                | RF                       | Must        | <a href="#Brainstorming" > Brainstorming </a> ,  <a href="#mapa-mental" > Mapa Mental </a>|
| US11 | E02 - Itens | FE04 - Solicitar item               | Eu como usuário membro de uma ONG desejo remover um item da lista de itens que preciso                                                             | RF                       | Must        | <a href="#Brainstorming" > Brainstorming </a> |
| US12 | E02 - Itens | FE04 - Solicitar item               | Eu como usuário membro de uma ONG desejo ver quais itens foram doados para minha instituição                                                       | RF                       | Could       | <a href="#Brainstorming" > Brainstorming </a> |
| US13 | E02 - Itens | FE05 - Avaliar item                 | Eu como usuário membro de uma ONG desejo avaliar os itens que foram doados para minha instituição                                                  | RF                       | Could       | <a href="#Brainstorming" > Brainstorming </a> |
...
| US18 | EO3 - Interação Usuário | FE07 - Ludificação                  | Eu como usuário membro de uma ONG desejo receber pontos de credibilidade pela quantidade de pessoas ajudadas nas ações sociais                     | RF                       | Won,t       | <a href="#Brainstorming" > Brainstorming </a> |
| US19 | EO3 - Interação Usuário | FE08 - Ações sociais                | Eu como usuário do site desejo saber quando e onde acontecerão as próximas ações sociais das ONG's cadastradas no site                             | RF                       | Should      | <a href="#Brainstorming" > Brainstorming </a> ,  <a href="#mapa-mental" > Mapa Mental </a> |
...
| US21 | EO3 - Interação Usuário | FE08 - Ações sociais                | Eu como usuário membro de uma ONG desejo adicionar minhas ações sociais                                                                            | RF                       | Must        | <a href="#Brainstorming" > Brainstorming </a> ,  <a href="#mapa-mental" > Mapa Mental </a> |
...
| US35 | EO4 - Experiencia do Usuário | FE15 - Suportabilidade              | Eu como usuário desejo poder utilizar o sistema em aparelhos distintos por meio de uma aplicação web acesssivél em navegadores distintos           | US36                     | Could       | <a href="#Introspeccao" > Introspecção </a> , <a href="#mapa-mental" > Mapa Mental </a>  |
