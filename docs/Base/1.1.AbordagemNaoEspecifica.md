...
O diagrama de Ishikawa (Diagrama de Causa e Efeito), visa encontrar potenciais causas de um evento específico sobre diferentes perspectivas, ou seja, descobrir e documentar os fatores que resultam em situações indesejadas. 
