...
O Diagrama de Ishikawa ou Diagrama Causa-Efeito tem como objetivo auxliar na identificação de problemas e suas causas, tratando o objetivo de estudo de 6 principais perpectivas(Método, Máquina, Medida, Meio Ambiente, Material e Mão de Obra).
