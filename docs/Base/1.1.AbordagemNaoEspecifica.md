...
No conceito de Léxico na etapa de Abordagem Não Específica, vamos utiliza-los para definir os sinônimos, noção, impacto e classificação das palavras.

Palavras a serem colocadas no léxico (a fazer):
- Aplicação Web
- Doação/Doar
- ONGs 
- Doadores
