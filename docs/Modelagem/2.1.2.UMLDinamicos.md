...
Nós decidimos assim criar os diagrams abaixo de acordo com nossos casos de uso mais importantes utilizando a ferramenta [LucidChart](https://www.lucidchart.com/pages/pt).
#### Diagrama de cadastro de usuário
![Diagrama de sequencia - fluxo de cadastro de usuario](../imgs/DS_cadastro.pdf)
#### Diagrama de Login/logout Doador
![Diagrama de sequencia - fluxo de Login/logout de usuario doador](../imgs/DS_login_doador.pdf)
#### Diagrama de Login/logout Ong
![Diagrama de sequencia - fluxo de Login/logout de usuario ong](../imgs/DS_login_ong.pdf)
## 2.1.5. Referências
