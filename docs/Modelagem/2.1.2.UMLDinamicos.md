...
Esse diagrama ilustra as interações entre o fluxo do doador e o sistema associados com linhas de vida e mensagens transmitidas entre linhas de vida.
Existem vários aspectos de interação desse diagrama, por exemplo:

- Se o doador pesquisar por uma ação social, o sistema deve permitir que ela faça a doação de um item.

- Se o item for doado, o doador deve receber um feedback.

- Se o usuário pesquisar por perfil, ele pode vizualizar as ações sociais e doar um item.

Aqui evidencia-se a US06, US09 e US15 do nosso Backlog do Produto.
...
Esse diagrama ilustra as interações entre o fluxo da ONG e o sistema associados com linhas de vida e mensagens transmitidas entre linhas de vida.
Existem vários aspectos de interação desse diagrama, por exemplo:

- Se um membro da ONG receber um item doado, ele precisa avaliar a qualidade e retonar um feedback para o doador.

Aqui evidencia-se a US14  nosso Backlog do Produto.
