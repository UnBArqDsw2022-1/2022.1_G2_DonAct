...
Esse diagrama ilustra como é o processo de cadastrar uma conta. Aqui o detalhe é que o processo de cadastro é de um usuário, que se especializa em ONG ou doador a partir da escolha no menu. Aqui evidencia-se a **US02 e US03** do nosso Backlog do Produto.
