...
| 1.1    | Adição de Grasp Baixo Acoplamento | Antonio Neto e Júlia Farias   | 06/08/2022 |
...
Acoplamento é a medida de quanto um elemento está conectado a, ou 
depende de outros elementos [[BACALÁ]](#ref1). Uma classe com forte acoplamento depende de outras classes, o que pode gerar fatores indesejáveis como baixa reutilização e maior impacto com mudanças.

Segundo Sílvio Bacalá, o acoplamento tem relação com a coesão, de forma inversamente proporcional. Ou seja, quanto maior a coesão, menor o acomplamento [[BACALÁ]](#ref1).  


### **Utilização no projeto**: 

Pode ser visto na seleção abaixo do diagrama de classe da aplicação que a  classe Usuário possui uma sobrecarga de funções, entre elas cadastrar usuário, editar usuário e apagar a conta. Posto isto, podemos aplicar os padrões de **Alta Coesão** e **Baixo Acomplamento** nesse cenário.
...
![GRASP de Alta Coesão e Baixo Acoplamento](../imgs/AltaCoesao_2.png)
