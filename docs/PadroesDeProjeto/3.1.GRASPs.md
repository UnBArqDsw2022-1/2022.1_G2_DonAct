...
| 1.1    | Adição de Grasp Baixo Acoplamento e Polimorfismo | Antonio Neto e Júlia Farias   | 05/08/2022 |
| 1.1    | Validação e correções | Luiz Henrique   | 05/08/2022 |
| 1.2    | Validação do Grasp Especialista | Cibele Goudinho   | 07/08/2022 |
| 1.3    | Validação e correções | Yan Andrade   | 08/08/2022 |
...
Segundo Sílvio Bacalá, o acoplamento tem relação com a coesão, de forma inversamente proporcional. Ou seja, quanto maior a coesão, menor o acoplamento [[BACALÁ]](#ref1).  

### 3.1.1.6. GRASP de Polimorfismo

Também pode-se utilizar o conceito de Polimorfismo de orientação a objetos para melhorar nossas classes. "Quando alternativas ou comportamentos relacionados variam com o tipo (classe), atribuia as responsabilidades aos tipos usando operações polimórficas." [[BACALÁ]](#ref1) 
...
Posto isto, é possível aplicar os padrões de **Alta Coesão** e **Baixo Acomplamento** nesse cenário. Ou seja, pode-se dividir ela em uma classe *Usuário* que terá os atributos necessários para o usuário. Depois criar três classes que herdarão os atributos da classe *Usuário* que serão específicas para cadastrar, editar ou apagar o perfil. 

Ademais, são criadas classes que herdam atributos da classe *Usuário*, dessa forma, aplicando o padrão de **Polimorfismo**. 
