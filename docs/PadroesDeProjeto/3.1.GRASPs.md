...
| 1.4    | Validação e correções | Isadora Soares   | 08/08/2022 |
...
Também pode-se utilizar o conceito de Polimorfismo de orientação a objetos para melhorar nossas classes. "Quando alternativas ou comportamentos relacionados variam com o tipo (classe), atribuía as responsabilidades aos tipos usando operações polimórficas." [[BACALÁ]](#ref1) 
