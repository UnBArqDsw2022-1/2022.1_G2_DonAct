...
<p align="justify">&emsp;&emsp;Creator(Criador abstrato) — declara o factory method que retorna o objeto da classe Product (produto). Este elemento também pode definir uma implementação básica que retorna um objeto de uma classe ConcreteProduct (produto concreto) básica;</p>

<p align="justify">&emsp;&emsp;ConcreteCreator(Criador concreto) — sobrescreve o factory method e retorna um objeto da classe ConcreteProduct;</p>

<p align="justify">&emsp;&emsp;Product(Produto abstrato) — define uma interface para os objectos criados pelo factory method;</p>

<p align="justify">&emsp;&emsp;ConcreteProduct(Produto concreto) — uma implementação para a interface Product.</p>
...
- Na ConcreteClass que define de forma mais detalhada os métodos especificados na , temos duas opcões de login, podendo ser Doador ou OnG. 
- Na ConcreteClass que define de forma mais detalhada os métodos especificados na AbstractClass, temos duas opcões de login, podendo ser Doador ou OnG. 
