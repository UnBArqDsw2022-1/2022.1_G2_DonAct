...
<p align="justify">&emsp;&emsp; DiAGRAMA.. </p>
...
_Imagem 3: Modelo do GoF Comportamental Strategy_

#### Aplicação no Projeto

Explicar a aplicação do GoF no projeto.

![Strategy](../imgs/GoFComportamental.png)
_Imagem 3: GoF Strategy no Projeto_
