...
| 1.1    | Adicionando referências no texto do padrão Builder                       | Yan Andrade                | 07/08/2022 |
| 1.2 | aplicação do GoF Template Method                      | Sávio Cunha                      | 07/08/2022 |
| 1.3    | Validando GoFs Criacionais                                                     | Victor Buendia e Felipe Agustini | 08/08/2022 |
| 1.4    | Finalizando Gofs Estruturais  | Antonio Neto e Luiz Henrique | 09/08/2022 |
| 1.5    | Validando GoFs Estruturais      | Isadora Soares e Cibele Goudinho| 08/08/2022 |
...
Trazendo para o contexto do nosso projeto iremos abordar o Factory Method e o Builder. 
...
<p align="justify">&emsp;&emsp;As interações entre os objetos de um sistema podem gerar fortes dependência entre eles, o que eventualmente resulta no maior custo de funcionamento e manuntenção do sistema.</p>
...
- Uma classe denominada *Leaf* que seriam as folha da estrutura em árvore, ou seja, não possuem classes abaixo dela. Essa classe redefine os métodos mais básicos do componente, e também implementa a interface.

### 3.2.2.2. Adapter

<p align="justify">&emsp;&emsp;Em suma, esse padrão Adapter consistem em um adaptador de um objeto para uma interface, tornando  possível um processo que seria incompatível. Assim tendo como principal objetivo a alteração um objeto permitindo a sua interação com o outro.</p>
...
_Imagem 7: Modelo GoF Template Method_
...
- Na ConcreteClass que define de forma mais detalhada os métodos especificados na , temos duas opções de login, podendo ser Doador ou OnG. 
...
_Imagem 8: GoF Template Method no Projeto_
